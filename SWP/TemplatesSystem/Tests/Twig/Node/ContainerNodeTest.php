...
use SWP\TemplatesSystem\Twig\Node\ContainerNode;
...
class ContainerNodeTest extends \Twig_Test_NodeTestCase
{
    ...
    {
        $name = new \Twig_Node(array(new \Twig_Node_Expression_Constant('container_name', 1)));
    ...
    {
        $name1 = new \Twig_Node(array(new \Twig_Node_Expression_Constant('container_name', 1)));
        ...
        $name2 = new \Twig_Node(array(new \Twig_Node_Expression_Constant('container_name', 2)));
        $body2 = new \Twig_Node_Text('Test body', 2);
        $node2 = new ContainerNode($name2, null, $body2, 2, 'gimme');

        $name3 = new \Twig_Node(array(new \Twig_Node_Expression_Constant('container_name', 3)));
